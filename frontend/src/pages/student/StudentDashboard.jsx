  ...
  return (
    <div style={{ fontFamily: "sans-serif", padding: "24px", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "28px" }}>
        <h1 style={{ margin: "0 0 6px" }}>Welcome back, {user?.name || "Student"} </h1>
        <p style={{ margin: 0, color: "#64748b", fontSize: "15px" }}>
          Here's your student portal. View your timetable to see your class schedule.
        </p>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "16px" }}>
        <DashboardCard
          icon=""
          title="My Timetable"
          description="View your weekly class schedule, rooms, and faculty."
